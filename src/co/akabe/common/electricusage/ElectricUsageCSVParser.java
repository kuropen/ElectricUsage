...
public class ElectricUsageCSVParser {
	...
	public static final SupplyDataFormat Format_Chubu = new SupplyDataFormat(
			"http://denki-yoho.chuden.jp/denki_yoho_content_data/juyo_cepco003.csv", 5, 2, 24, 76);
	...
	public static final SupplyDataFormatH Format_Hokkaido = new SupplyDataFormatH(
			"http://denkiyoho.hepco.co.jp/data/juyo_hokkaidou.csv", 5, 2, 11, 44);
	...
	public static SupplyDataFormat buildKyushuFormat() {
		return new SupplyDataFormat("http://www.kyuden.co.jp/power_usages/csv/juyo-hourly-"
	 ...
	 *
	 * @param URL
	 *            ソースURL ({@link #UsageDataURL_Tokyo},
	 ...
	 *             通信エラーまたは入力ストリームでエラーが発生した場合にスローします
	 * @since 1.0
	 */
	private Vector<String> readFromURL() throws IOException {
		...
		try {
			BufferedReader input = new BufferedReader(new InputStreamReader(inStream, df.charset));
